...
function SidebarComponent_div_7_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(3, "circle", 40)(4, "path", 41);
    \u0275\u0275elementEnd()();
    \u0275\u0275namespaceHTML();
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SidebarComponent, selectors: [["app-sidebar"]], outputs: { toggled: "toggled" }, standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 9, vars: 7, consts: [["collapsedLogo", ""], [1, "sidebar"], [1, "sidebar-header", 3, "click"], [4, "ngIf", "ngIfElse"], ["class", "sidebar-nav", 4, "ngIf"], [1, "sidebar-footer"], ["class", "sidebar-user", 4, "ngIf"], ["class", "sidebar-user-collapsed", 4, "ngIf"], [1, "sidebar-brand"], [1, "brand-text"], [1, "sidebar-brand-collapsed"], [1, "brand-text-collapsed"], [1, "sidebar-nav"], [1, "nav-section"], ["class", "nav-section-label", 4, "ngIf"], ["routerLinkActive", "active", "class", "nav-link", 3, "routerLink", "routerLinkActiveOptions", "title", 4, "ngFor", "ngForOf"], [1, "nav-section-label"], ["routerLinkActive", "active", 1, "nav-link", 3, "routerLink", "routerLinkActiveOptions", "title"], [3, "ngSwitch"], ["class", "nav-icon", "xmlns", "http://www.w3.org/2000/svg", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2", "stroke-linecap", "round", "stroke-linejoin", "round", 4, "ngSwitchCase"], [1, "nav-label", 3, "ngStyle"], ["xmlns", "http://www.w3.org/2000/svg", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2", "stroke-linecap", "round", "stroke-linejoin", "round", 1, "nav-icon"], ["width", "7", "height", "9", "x", "3", "y", "3", "rx", "1"], ["width", "7", "height", "5", "x", "14", "y", "3", "rx", "1"], ["width", "7", "height", "9", "x", "14", "y", "12", "rx", "1"], ["width", "7", "height", "5", "x", "3", "y", "16", "rx", "1"], ["d", "M5 17h14v-5l-1.5-3.5A2 2 0 0 0 15.7 7H8.3a2 2 0 0 0-1.8 1.5L5 12v5z"], ["cx", "7.5", "cy", "17", "r", "1.5"], ["cx", "16.5", "cy", "17", "r", "1.5"], ["d", "M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2"], ["cx", "12", "cy", "7", "r", "4"], ["d", "M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2"], ["width", "8", "height", "4", "x", "8", "y", "2", "rx", "1", "ry", "1"], ["d", "M12 11h4"], ["d", "M12 15h4"], ["d", "m8 11 2-2-2-2"], ["d", "m16 15-2-2 2-2"], [1, "sidebar-user"], [1, "user-avatar"], ["xmlns", "http://www.w3.org/2000/svg", "viewBox", "0 0 24 24", "fill", "currentColor", "stroke", "none"], ["cx", "12", "cy", "8", "r", "4"], ["d", "M 12 14 C 8 14 5 16.5 5 20 L 5 22 L 19 22 L 19 20 C 19 16.5 16 14 12 14 Z"], [1, "user-info"], [1, "user-name"], [1, "user-role"], [1, "sidebar-user-collapsed"], [1, "user-avatar-sm"]], template: function SidebarComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275template(7, SidebarComponent_div_7_Template, 10, 2, "div", 6)(8, SidebarComponent_div_8_Template, 5, 0, "div", 7);
        \u0275\u0275elementEnd()();
      }
      if (rf & 2) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SidebarComponent, { className: "SidebarComponent", filePath: "app\\shared\\components\\sidebar\\sidebar.component.ts", lineNumber: 250 });
})();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AppComponent, { className: "AppComponent", filePath: "app\\app.component.ts", lineNumber: 99 });
})();
...
var appRoutes = [
  ...
  { path: "login", loadComponent: () => import("./chunk-MI3KC6SZ.js").then((m) => m.LoginComponent) },
  { path: "registro", loadComponent: () => import("./chunk-CLGMV6IO.js").then((m) => m.RegistroComponent) },
  { path: "dashboard", loadComponent: () => import("./chunk-LO5PLOP5.js").then((m) => m.DashboardComponent), canActivate: [authGuard] },
  { path: "veiculos", loadComponent: () => import("./chunk-W62RQXXI.js").then((m) => m.VeiculosComponent), canActivate: [authGuard] },
  { path: "motoristas", loadComponent: () => import("./chunk-PEB7ADEB.js").then((m) => m.MotoristasComponent), canActivate: [authGuard] },
  { path: "alugueis", loadComponent: () => import("./chunk-DH6TIU32.js").then((m) => m.AlugueisComponent), canActivate: [authGuard] },
